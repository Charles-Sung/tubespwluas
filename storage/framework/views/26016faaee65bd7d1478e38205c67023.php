...
<div class="space-y-8">
    ...
    <div class="relative bg-gradient-to-r from-slate-900 to-indigo-950 border border-indigo-900/40 p-6 md:p-8 rounded-3xl overflow-hidden shadow-2xl shadow-indigo-950/20">
        ...
        <div class="relative max-w-2xl">
            <h2 class="text-2xl md:text-3xl font-extrabold text-white mb-2">Selamat Datang, <?php echo e(session('user')['name']); ?>!</h2>
            ...
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo e(route('items.create')); ?>" class="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-lg shadow-indigo-600/20 transition-all duration-150">
                    + Tambah Barang Baru
                </a>
                <a href="<?php echo e(route('rooms.create')); ?>" class="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-semibold transition-all duration-150 border border-slate-700">
                    + Tambah Ruangan
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div class="bg-slate-950/40 border border-slate-800 p-5 rounded-2xl flex items-center justify-between shadow-xl">
            <div class="space-y-1">
                ...
                <h3 class="text-2xl font-bold text-slate-100"><?php echo e($stats['users_count']); ?></h3>
        ...
        <div class="bg-slate-950/40 border border-slate-800 p-5 rounded-2xl flex items-center justify-between shadow-xl">
            <div class="space-y-1">
                ...
                <h3 class="text-2xl font-bold text-slate-100"><?php echo e($stats['rooms_count']); ?></h3>
        ...
        <div class="bg-slate-950/40 border border-slate-800 p-5 rounded-2xl flex items-center justify-between shadow-xl">
            <div class="space-y-1">
                ...
                <h3 class="text-2xl font-bold text-slate-100"><?php echo e($stats['items_count']); ?></h3>
        ...
        <div class="bg-slate-950/40 border border-slate-800 p-5 rounded-2xl flex items-center justify-between shadow-xl">
            <div class="space-y-1">
                ...
                <h3 class="text-2xl font-bold text-slate-100"><?php echo e($stats['total_stock']); ?></h3>
    ...
    <div class="bg-slate-950/30 border border-slate-800 rounded-2xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <!-- Card 1 -->
            <a href="<?php echo e(route('users.index')); ?>" class="group block p-5 rounded-xl bg-slate-950/50 hover:bg-indigo-950/10 border border-slate-800 hover:border-indigo-500/20 transition-all duration-200">
            ...
            <!-- Card 2 -->
            <a href="<?php echo e(route('rooms.index')); ?>" class="group block p-5 rounded-xl bg-slate-950/50 hover:bg-emerald-950/10 border border-slate-800 hover:border-emerald-500/20 transition-all duration-200">
            ...
            <!-- Card 3 -->
            <a href="<?php echo e(route('items.index')); ?>" class="group block p-5 rounded-xl bg-slate-950/50 hover:bg-violet-950/10 border border-slate-800 hover:border-violet-500/20 transition-all duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tubespwluas-main\resources\views/dashboard.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Capstone Admin</title>
...
<body class="bg-slate-900 text-slate-100 min-h-screen flex flex-col md:flex-row">
    ...
    <aside class="w-full md:w-64 bg-slate-950 border-b md:border-b-0 md:border-r border-slate-800 flex flex-col shrink-0">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard') ? 'bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-lg shadow-indigo-600/10' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'); ?>">
            ...
            <a href="<?php echo e(route('users.index')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('users.*') ? 'bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-lg shadow-indigo-600/10' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'); ?>">
            ...
            <a href="<?php echo e(route('rooms.index')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('rooms.*') ? 'bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-lg shadow-indigo-600/10' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'); ?>">
            ...
            <a href="<?php echo e(route('items.index')); ?>" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('items.*') ? 'bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-lg shadow-indigo-600/10' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'); ?>">
            ...
            <?php if(session()->has('user')): ?>
                <div class="flex items-center gap-3 px-2">
                    ...
                    <div class="overflow-hidden">
                        <p class="text-sm font-semibold text-slate-200 truncate"><?php echo e(session('user')['name']); ?></p>
                        <p class="text-xs text-slate-500 truncate"><?php echo e(session('user')['email']); ?></p>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <main class="flex-1 flex flex-col min-h-0 bg-slate-900">
        ...
        <header class="h-16 bg-slate-950/30 border-b border-slate-800/80 flex items-center justify-between px-6 md:px-8">
            <h1 class="text-xl font-bold text-slate-200"><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?></h1>
            <div class="flex items-center gap-4">
                <span class="text-xs bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 px-3 py-1 rounded-full font-medium">Role: <?php echo e(ucfirst(session('user')['role'] ?? 'Guest')); ?></span>
            </div>
        </header>
...
<?php /**PATH C:\xampp\htdocs\tubespwluas-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>